...
🧑‍💻 **증거를 기반으로 위협을 탐지하고 분석하는** 🛡️  
**Junior Security Analyst (Blue Team / SOC)** 입니다.
...
* ⏳ **정보보안산업기사** — 과정평가형 외부평가 준비 중
* 📘 **정보보안기사** — 학습 및 준비 중
* 📘 **리눅스마스터 2급** — 학습 및 시험 준비 중

---

## 📂 Featured Security Projects

* **🛡️ Wazuh Security Monitoring Lab**: Linux 보안 로그 수집, SSH 브루트 포스 탐지 및 FIM(무결성 모니터링) 구축
* **🔥 pfSense Network Security Lab**: 가상 네트워크 세그멘테이션(WAN/LAN), 방화벽 정책 수립 및 트래픽 분석
* **🔍 Linux Security Log Analysis**: 인증 로그(`auth.log`, `secure`) 기반 공격 타임라인 구축 및 침해사고 분석 실습
